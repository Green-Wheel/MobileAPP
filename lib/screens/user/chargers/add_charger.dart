...
class _AddChargerState extends State<AddCharger> {
  ...
  void _setSpeeds(speeds) {
    /*setState(() {
      this._data["speed"] = speeds;
    });*/
    print (_data["speed"]);
  }
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: DropdownButton(
                  ...
                  onChanged: (value) {
                    setState(() => _data['velocity'] = value.toString());
                  },
                ),
              ),
              SizedBox(height: 10),
                    ...
                    if (_formKey.currentState!.validate()) {
                      ...
                      showDialog(
                          ...
                          builder: (BuildContext context) => AlertDialog(
                            title: const Text('Form _data is: '),
                            content: Text(_data.toString()),
                            actions: <Widget>[
                              TextButton(
