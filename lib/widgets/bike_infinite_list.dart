...
class _BikeInfiniteList extends State<BikeInfiniteList>{
  ...
  //funcion respectiva a la card de las bicicletas
  /*Widget _cardBikeList(String direction, bool available, BikeType bikeType, double price, int id, double rate, double latitude, double longitude){
    ...
    return GestureDetector(
      ...
      child: BikeCardInfoWidget(location: direction, rating: rate, available: available, type: bikeType, price: price, direction: direction1, description: description, bike_list: true, power: 0, latitude: latitude, longitude: longitude),
    );
